...
void LevelTwoActivity::renderHUD()
{
	...
	glPrint(std::to_string((int)L2hero.badgeCount) + " x ");	// Print GL Text To The Screen

	glRasterPos2f(1.6, 13);

	glPrint("Score:" + std::to_string((int)L2hero.playerScore));	// Print GL Text To The Screen
